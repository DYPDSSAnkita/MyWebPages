...
#header {
    background-image: url("https://uploads-ssl.webflow.com/5e4dfa5d58d02b574c094981/5e61b936452770f1cc437223_Render%20Engine%20Blur.jpg");
...
<body>
  ...
  <header>
        <nav id="navbar">
            ...
            <a href="#work" class="nav-link">My Projects</a>
  ...
  <div id="header" class="section">
    <img alt="" class="img-circle" src="https://www.brillcool.com/pub/media/testimonial/u/s/user.png">
    <p>Student name goes here with the image in above circle</p>
  </div>
  <!-- header image end -->
  ...
  <div class="section">
    ...
    <p>
      Hey! I'm <b>student</b>. fill up this paragraph tag with the details about your name,school,class and other important information which concerns about you by removing the dummy content below. <strike>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</strike>
    </p>
  </div>
  ...
  <!-- Form section start -->
  <!-- Submit button will send the details to the mail id given in form action attribute -->
  <div class="section">
